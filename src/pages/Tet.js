    ...
    <div className="container mx-auto">
      <div className="py-4">
        <table className="table border shadow text-center">
          <thead>
            <tr>
              <th scope="col"> id </th> <th scope="col"> Start date </th>{" "}
              <th scope="col"> End date </th> <th scope="col"> Description </th>{" "}
          ...
          <tbody>
            ...
            {events.map((event, index) => (
              <tr key={event.id}>
                <th scope="row"> {index + 1} </th> <td> {event.start_date} </td>{" "}
                <td> {event.end_date} </td> <td> {event.text} </td>{" "}
                <td>
                  <button
